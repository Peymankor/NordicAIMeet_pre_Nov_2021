...
class BDP():
    ...
    def __init__(self, discrete_prices, discrete_energy, discrete_price_changes,
                 f_p, stop_time, model):
        """
    ...
    def state_transition(self, state, decision, exog_info):
        ...
        adjusted_new_energy = new_energy
    ...
    def bellman(self):
        ...
        while time != -1:
            ...
            for state in self.possible_states:
                ...
                #print("--------------------------------------------------------------------")
                #print("The price: {} and energy: {}".format(price, energy))
                v_list = []
                for d in self.model.possible_decisions:
                    ...
                    for w in self.discrete_price_changes:
                        ...
                        #print("next state: {}, next_v {}".format(next_state, next_v))
                        sum_w += f * next_v
                        #sum_w += 0.5*next_v
                        w_index += 1
                    ...
                    #print("the contribution value {}, the sum_w value {}, v value {}".format(contribution,sum_w,v))
